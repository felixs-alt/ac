...
async def gamecheck():
    ...
    while True:
        ...
        os.system(f"wget -o main.mp3 https://cloud.oscie.net/acdp/{gameweather}/{gametime}.mp3")
        os.system(f"ffmpeg -i  main.mp3  -listen 1 -method GET -c copy -f MP3 http://0.0.0.0:5000")
